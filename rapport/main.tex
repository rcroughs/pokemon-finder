...
\texttt{-maxdepth 1} afin qu'on ne cherche pas les images dans les sous-fichiers qui peuvent se trouver dans le fichier de recherche. Egalement, nous allons inclure 
...
Finalement, nous devions créer une script qui permette de lancer notre programme. Nous avions donc deux modes à gérer, comme il est décrit dans l'énoncé. 
